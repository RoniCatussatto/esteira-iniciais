...
const novoConfig = {
  ...
  "camposExtracao": [
    ...
    {
      "campo": "valorQuitacao",
      "descricao": "Saldo para Quitação (Valor Líquido): linha 43 se numérica, senão linha 29",
      "localizacao": "linha 43 (com fallback para linha 29)",
      "linhaEspecial": "saldoQuitacao",
